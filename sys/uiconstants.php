...
// The top portion of the UI
class UIStatic {
    const CivInfo = "infoCiv";
    const MoneyInfo = "infoMoney";
    const Starmap = "tmbStarmap";
    const System = "tmbSystem";
    const Diplomacy = "tmbDiplomacy";
